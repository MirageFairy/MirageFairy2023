...
fun getPassiveSkillTooltip(itemStack: ItemStack, mana: Double, passiveSkills: List<PassiveSkill>): List<Text> {
    ...
    passiveSkills.forEach { passiveSkill ->
        ...
        // 追加
        tooltip += text {
            val effectText = passiveSkill.effect.getText(mana / 10.0)
