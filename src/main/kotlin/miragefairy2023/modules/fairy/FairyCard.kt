...
enum class FairyCard(
    ...
    AIR(
        ...
        listOf(PassiveSkillProvider(listOf(OverworldPassiveSkillCondition(), AirPassiveSkillCondition()), MovementSpeedPassiveSkillEffect(0.30))),
        RecipeContainer().always().block { Blocks.AIR },
    ),
    LIGHT(
        "light", 3, "Lightia", "光精リグチャ", 0xFFFFD8, 0xFFFFD8, 0xFFFFC5, 0xFFFF00,
        listOf(PassiveSkillProvider(listOf(MinimumLightLevelPassiveSkillCondition(12)), MovementSpeedPassiveSkillEffect(0.30))),
        RecipeContainer().always(),
    ),
    FIRE(
        "fire", 2, "Firia", "火精フィーリャ", 0xFF6C01, 0xF9DFA4, 0xFF7324, 0xFF4000,
        listOf(PassiveSkillProvider(listOf(OnFirePassiveSkillCondition()), AttackDamagePassiveSkillEffect(4.0))),
    ...
    WATER(
        ...
        listOf(PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition()), MaxHealthPassiveSkillEffect(12.0))),
    ...
    LAVA(
        ...
        listOf(
            PassiveSkillProvider(listOf(OnFirePassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.0)),
    ...
    RAIN(
        ...
        listOf(PassiveSkillProvider(listOf(InRainPassiveSkillCondition()), AttackDamagePassiveSkillEffect(4.0))),
        RecipeContainer().overworld(),
    ),
    DIRT(
        "dirt", 1, "Dirtia", "土精ディルチャ", 0xB87440, 0xB9855C, 0x593D29, 0x914A18,
        listOf(PassiveSkillProvider(listOf(OverworldPassiveSkillCondition()), MaxHealthPassiveSkillEffect(10.0))),
    ...
    MYCELIUM(
        ...
        listOf(
            PassiveSkillProvider(listOf(), AttackDamagePassiveSkillEffect(1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)), AttackDamagePassiveSkillEffect(2.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)), MaxHealthPassiveSkillEffect(12.0)),
    ...
    SCULK(
        ...
        listOf(
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(0)), MaxHealthPassiveSkillEffect(8.0)),
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(0)), AttackDamagePassiveSkillEffect(3.0)),
        ),
    ...
    STONE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.STONE)), AttackDamagePassiveSkillEffect(2.0)),
    ...
    DRIPSTONE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.5)),
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), MaxHealthPassiveSkillEffect(6.0)),
        ),
    ...
    REINFORCED_DEEPSLATE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), MaxHealthPassiveSkillEffect(10.0)),
        ),
    ...
    ANCIENT_DEBRIS(
        ...
        listOf(
            PassiveSkillProvider(listOf(), AttackDamagePassiveSkillEffect(1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), AttackDamagePassiveSkillEffect(1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), MaxHealthPassiveSkillEffect(2.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), LuckPassiveSkillEffect(2.0)),
        ),
    ...
    PURPUR(
        ...
        listOf(
            PassiveSkillProvider(listOf(), CollectionPassiveSkillEffect(0.5)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)), AttackDamagePassiveSkillEffect(2.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)), MaxHealthPassiveSkillEffect(4.0)),
        ),
    ...
    COPPER(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.2)),
            PassiveSkillProvider(listOf(ThunderingPassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.5)),
        ),
    ...
    IRON(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.IRON)), AttackDamagePassiveSkillEffect(2.0)),
    ...
    GOLD(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.8)),
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.GOLD)), AttackDamagePassiveSkillEffect(2.0)),
    ...
    NETHERITE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.NETHERITE)), AttackDamagePassiveSkillEffect(2.0)),
    ...
    MIRANAGITE(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5)),
            // TODO 妖精のレア度上昇
        ),
    ...
    AMETHYST(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5)),
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(7)), AttackDamagePassiveSkillEffect(0.5)),
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(7)), LuckPassiveSkillEffect(2.0)),
        ),
    ...
    EMERALD(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5)),
            PassiveSkillProvider(listOf(InVillagePassiveSkillCondition()), LuckPassiveSkillEffect(1.5)),
        ),
    ...
    COAL(
        ...
        listOf(
            PassiveSkillProvider(listOf(), MaxHealthPassiveSkillEffect(4.0)),
            PassiveSkillProvider(listOf(OnFirePassiveSkillCondition()), LuckPassiveSkillEffect(2.0)),
        ),
    ...
    REDSTONE(
        ...
        listOf(
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), LuckPassiveSkillEffect(0.5)),
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.0)),
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), MaxHealthPassiveSkillEffect(2.0)),
        ),
    ...
    LAPIS_LAZULI(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5)),
            PassiveSkillProvider(listOf(OverworldPassiveSkillCondition()), LuckPassiveSkillEffect(1.5)),
        ),
    ...
    GLOWSTONE(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), AttackDamagePassiveSkillEffect(1.5)),
        ),
    ...
    SPONGE(
        ...
        listOf(
            PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.0)),
    ...
    PLAYER(
        ...
        listOf(PassiveSkillProvider(listOf(MaximumLevelPassiveSkillCondition(29)), ExperiencePassiveSkillEffect(0.1))),
    ...
    ENDERMAN(
        ...
        listOf(PassiveSkillProvider(listOf(), CollectionPassiveSkillEffect(1.0))),
    ...
    ZOMBIE(
        ...
        listOf(
            PassiveSkillProvider(listOf(MaximumFoodLevelPassiveSkillCondition(6)), AttackDamagePassiveSkillEffect(2.0)),
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.0)),
        ),
    ...
    SKELETON_HORSE(
        ...
        listOf(
            PassiveSkillProvider(listOf(MaximumFoodLevelPassiveSkillCondition(6)), MovementSpeedPassiveSkillEffect(0.30)),
            PassiveSkillProvider(listOf(InRainPassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.0)),
        ),
    ...
    WHEAT(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BREAD }), RegenerationPassiveSkillEffect(0.3)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BREAD }), AttackDamagePassiveSkillEffect(0.5)),
        ),
    ...
    POTATO(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BAKED_POTATO }), RegenerationPassiveSkillEffect(0.2)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BAKED_POTATO }), AttackDamagePassiveSkillEffect(1.0)),
        ),
    ...
    POISONOUS_POTATO(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), AttackDamagePassiveSkillEffect(1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.POISONOUS_POTATO }), AttackDamagePassiveSkillEffect(2.0)),
        ),
    ...
    BEETROOT(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BEETROOT }), AttackDamagePassiveSkillEffect(2.0)),
        ),
    ...
    MELON(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.MELON_SLICE }), RegenerationPassiveSkillEffect(0.4)),
        ),
    ...
    WOOD(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.WOOD)), AttackDamagePassiveSkillEffect(2.0)),
    ...
    HOE(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(HasHoePassiveSkillCondition()), LuckPassiveSkillEffect(3.0)),
        ),
    ...
    CRAFTING_TABLE(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), LuckPassiveSkillEffect(2.0))),
    ...
    ANVIL(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.0))),
    ...
    ENCHANTING_TABLE(
        ...
        listOf(
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition(), MaximumLevelPassiveSkillCondition(19)), ExperiencePassiveSkillEffect(0.04)),
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition(), MaximumLevelPassiveSkillCondition(29)), ExperiencePassiveSkillEffect(0.06)),
        ),
    ...
    HOPPER(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), CollectionPassiveSkillEffect(1.5))),
    ...
    IRON_BARS(
        ...
        listOf(PassiveSkillProvider(listOf(), MaxHealthPassiveSkillEffect(5.0))),
    ...
    TIME(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(), MovementSpeedPassiveSkillEffect(0.20)),
    ...
    DREAM(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(1.0)),
            PassiveSkillProvider(listOf(), RegenerationPassiveSkillEffect(0.1)),
