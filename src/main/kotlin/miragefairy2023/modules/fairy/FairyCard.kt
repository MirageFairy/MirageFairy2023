...
enum class FairyCard(
    ...
    FISH(
        ...
        listOf(PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition()), { StatusEffectPassiveSkillEffect(StatusEffects.NIGHT_VISION, 0, additionalSeconds = 10) })),
    ...
    CLOWNFISH(
        ...
        listOf(PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition(), MinimumLightLevelPassiveSkillCondition(4)), { StatusEffectPassiveSkillEffect(StatusEffects.WATER_BREATHING, 0) })),
        RecipeContainer().common().recipe { Items.TROPICAL_FISH },
    ),
    PLAYER(
        "player", 5, "Playeria", "人精プライェーリャ", 0xB58D63, 0x00AAAA, 0x322976, 0x4B3422,
        listOf(PassiveSkillProvider(listOf(MaximumLevelPassiveSkillCondition(29)), { ExperiencePassiveSkillEffect(0.5) })),
        RecipeContainer().common(),
    ),
    ENDERMAN(
        "enderman", 6, "Endermania", "終界人精エンデルマーニャ", 0x000000, 0x161616, 0x161616, 0xEF84FA,
        listOf(PassiveSkillProvider(listOf(), { CollectionPassiveSkillEffect(4.0) })),
        RecipeContainer().common(),
    ),
    WARDEN(
    ...
    HOE(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(HasHoePassiveSkillCondition()), { LuckPassiveSkillEffect(0.5) }),
        ),
    ...
    CRAFTING_TABLE(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), { LuckPassiveSkillEffect(0.5) })),
    ...
    ENCHANTING_TABLE(
        ...
        listOf(
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition(), MaximumLevelPassiveSkillCondition(19)), { ExperiencePassiveSkillEffect(0.2) }),
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition(), MaximumLevelPassiveSkillCondition(29)), { ExperiencePassiveSkillEffect(0.3) }),
        ),
    ...
    HOPPER(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), { CollectionPassiveSkillEffect(2.0) })),
    ...
    PLAINS(
        ...
        listOf(PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.PLAINS)), { StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 0) })),
        RecipeContainer().common(),
    ),
    OCEAN(
        "ocean", 3, "Oceania", "海精オツェアーニャ", 0x7DAEF5, 0x1B6CE9, 0x191CF0, 0x004DA5,
        listOf(PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.OCEAN)), { StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 0) })),
        RecipeContainer().common(),
    ),
    TAIGA(
        "taiga", 5, "Taigia", "針葉樹林精タイギャ", 0x5D985E, 0x476545, 0x223325, 0x5A3711,
        listOf(PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.TAIGA)), { StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 0) })),
        RecipeContainer().common(),
    ),
    MOUNTAIN(
        "mountain", 6, "Mountainia", "山精モウンタイニャ", 0x84BF80, 0xB1B0B1, 0x717173, 0xF0F0F0,
        listOf(PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MOUNTAIN)), { StatusEffectPassiveSkillEffect(StatusEffects.JUMP_BOOST, 1) })),
        RecipeContainer().common(),
    ),
    FOREST(
        "forest", 3, "Forestia", "森精フォレスチャ", 0x8EBF7A, 0x7B9C62, 0x89591D, 0x2E6E14,
        listOf(PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FOREST)), { StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 0) })),
        RecipeContainer().common(),
    ),
    DESERT(
        "desert", 4, "Desertia", "砂漠精デセルチャ", 0xF9F0C8, 0xDDD6A5, 0xD6CE9D, 0x656054,
        listOf(
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.DESERT), SunshinePassiveSkillCondition()), { StatusEffectPassiveSkillEffect(StatusEffects.FIRE_RESISTANCE, 0) }),
    ...
    AVALON(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FLORAL)), { StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 0) }),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FLORAL)), { StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 0) }),
        ),
