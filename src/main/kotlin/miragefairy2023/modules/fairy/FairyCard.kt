...
enum class FairyCard(
    ...
    val initializer: RecipeInitializer,
) {
    AIR(
        ...
        RecipeInitializer().common().block { Blocks.AIR },
    ),
    LIGHT(
    ...
    FIRE(
        ...
        RecipeInitializer().common().block { Blocks.FIRE },
    ),
    WATER(
        ...
        RecipeInitializer().common().block { Blocks.WATER }.recipe { Items.WATER_BUCKET },
    ),
    LAVA(
        ...
        RecipeInitializer().common().block { Blocks.LAVA }.recipe { Items.LAVA_BUCKET },
    ),
    MOON(
    ...
    DIRT(
        ...
        RecipeInitializer().common().block { Blocks.DIRT }.recipe { Items.DIRT },
    ),
    SCULK(
        ...
        RecipeInitializer().common().block { Blocks.SCULK }.recipe { Items.SCULK },
    ),
    IRON(
        ...
        RecipeInitializer().common().block { Blocks.IRON_BLOCK }.recipe { Items.IRON_INGOT },
    ),
    GOLD(
        ...
        RecipeInitializer().common().block { Blocks.GOLD_BLOCK }.recipe { Items.GOLD_INGOT },
    ),
    DIAMOND(
        ...
        RecipeInitializer().common().block { Blocks.DIAMOND_BLOCK }.recipe { Items.DIAMOND },
    ),
    FISH(
        ...
        RecipeInitializer().common().recipe { Items.COD }, // TODO 魚精は希釈で得る
    ),
    CLOWNFISH(
        ...
        RecipeInitializer().common().recipe { Items.TROPICAL_FISH },
    ),
    PLAYER(
    ...
    SPRUCE(
        ...
        RecipeInitializer().common().block { Blocks.SPRUCE_SAPLING }.recipe { Items.SPRUCE_SAPLING },
    ),
    HOE(
        ...
        RecipeInitializer().recipe { Items.STONE_HOE },
    ),
    CRAFTING_TABLE(
        ...
        RecipeInitializer().block { Blocks.CRAFTING_TABLE }.recipe { Items.CRAFTING_TABLE },
    ),
    ANVIL(
        ...
        RecipeInitializer().block { Blocks.ANVIL }.recipe { Items.ANVIL },
    ),
    ENCHANTING_TABLE(
        ...
        RecipeInitializer().block { Blocks.ENCHANTING_TABLE }.recipe { Items.ENCHANTING_TABLE },
    ),
    HOPPER(
        ...
        RecipeInitializer().block { Blocks.HOPPER }.recipe { Items.HOPPER },
    ),
    BEACON(
        ...
        RecipeInitializer().block { Blocks.BEACON }.recipe { Items.BEACON },
    ),
    GLASS(
        ...
        RecipeInitializer().block { Blocks.GLASS }.recipe { Items.GLASS },
    ),
    PRISMARINE(
        ...
        RecipeInitializer().block { Blocks.PRISMARINE }.recipe { Items.PRISMARINE },
    ),
    IRON_BARS(
        ...
        RecipeInitializer().block { Blocks.IRON_BARS }.recipe { Items.IRON_BARS },
    ),
    PLAINS(
    ...
    AVALON(
        ...
        RecipeInitializer().common(), // TODO イベント終了時コモン枠除去
    ),
    VOID(
        ...
        RecipeInitializer().common(), // TODO エンドのコモン
    ),
    NIGHT(
    ...
    class RecipeInitializer {
        val initializers = mutableListOf<RecipeProvider>()
    }
...
private fun FairyCard.RecipeInitializer.common() = this.also {
    this.initializers += object : FairyCard.RecipeProvider {
...
private fun FairyCard.RecipeInitializer.block(blockSupplier: () -> Block) = this.also {
    this.initializers += object : FairyCard.RecipeProvider {
...
private fun FairyCard.RecipeInitializer.recipe(inputItemSupplier: () -> Item) = this.also {
    this.initializers += object : FairyCard.RecipeProvider {
