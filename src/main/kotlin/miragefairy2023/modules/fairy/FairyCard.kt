...
enum class FairyCard(
    ...
    FIRE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(4.0).on(listOf(OnFirePassiveSkillCondition()))
        },
    ...
    WATER(
        ...
        listOf {
            MaxHealthPassiveSkillEffect(12.0).on(listOf(UnderwaterPassiveSkillCondition()))
        },
    ...
    LAVA(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(OnFirePassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 0).on(listOf(OnFirePassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 0).on(listOf(OnFirePassiveSkillCondition()))
        },
    ...
    MOON(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.NIGHT_VISION, 0, additionalSeconds = 10).on(listOf(MoonlightPassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 0).on(listOf(MoonlightPassiveSkillCondition()))
        },
    ...
    SUN(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 1).on(listOf(SunshinePassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 0).on(listOf(SunshinePassiveSkillCondition()))
        },
        FairyRecipes().overworld(),
    ),
    RAIN(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(4.0).on(listOf(InRainPassiveSkillCondition()))
        },
        FairyRecipes().overworld(),
    ),
    DIRT(
        ...
        listOf {
            MaxHealthPassiveSkillEffect(10.0).on(listOf(OverworldPassiveSkillCondition()))
        },
    ...
    MYCELIUM(
        ...
        listOf {
            ...
            AttackDamagePassiveSkillEffect(2.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)))
            MaxHealthPassiveSkillEffect(12.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)))
    ...
    SCULK(
        ...
        listOf {
            MaxHealthPassiveSkillEffect(8.0).on(listOf(MaximumLightLevelPassiveSkillCondition(0)))
            AttackDamagePassiveSkillEffect(3.0).on(listOf(MaximumLightLevelPassiveSkillCondition(0)))
        },
    ...
    STONE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.STONE)))
            StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.STONE)))
    ...
    DRIPSTONE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(1.5).on(listOf(ShadePassiveSkillCondition()))
            MaxHealthPassiveSkillEffect(6.0).on(listOf(ShadePassiveSkillCondition()))
        },
    ...
    REINFORCED_DEEPSLATE(
        ...
        listOf {
            MaxHealthPassiveSkillEffect(10.0).on(listOf(ShadePassiveSkillCondition()))
        },
    ...
    ANCIENT_DEBRIS(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(1.0).on(listOf())
            AttackDamagePassiveSkillEffect(1.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)))
            MaxHealthPassiveSkillEffect(2.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)))
            LuckPassiveSkillEffect(2.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)))
        },
    ...
    PURPUR(
        ...
        listOf {
            ...
            AttackDamagePassiveSkillEffect(2.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)))
            MaxHealthPassiveSkillEffect(4.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)))
        },
    ...
    COPPER(
        ...
        listOf {
            ...
            AttackDamagePassiveSkillEffect(2.5).on(listOf(ThunderingPassiveSkillCondition()))
        },
    ...
    IRON(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.IRON)))
            StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.IRON)))
    ...
    GOLD(
        ...
        listOf {
            ...
            AttackDamagePassiveSkillEffect(2.0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.GOLD)))
            StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.GOLD)))
    ...
    NETHERITE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.NETHERITE)))
            StatusEffectPassiveSkillEffect(StatusEffects.FIRE_RESISTANCE, 0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.NETHERITE)))
    ...
    AMETHYST(
        ...
        listOf {
            LuckPassiveSkillEffect(0.5).on(listOf())
            AttackDamagePassiveSkillEffect(0.5).on(listOf(MaximumLightLevelPassiveSkillCondition(7)))
            LuckPassiveSkillEffect(2.0).on(listOf(MaximumLightLevelPassiveSkillCondition(7)))
        },
    ...
    EMERALD(
        ...
        listOf {
            LuckPassiveSkillEffect(0.5).on(listOf())
            LuckPassiveSkillEffect(1.5).on(listOf(InVillagePassiveSkillCondition()))
        },
    ...
    DIAMOND(
        ...
        listOf {
            LuckPassiveSkillEffect(0.5).on(listOf())
            AttackDamagePassiveSkillEffect(2.0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.DIAMOND)))
            StatusEffectPassiveSkillEffect(StatusEffects.HASTE, 0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.DIAMOND)))
    ...
    COAL(
        ...
        listOf {
            ...
            LuckPassiveSkillEffect(2.0).on(listOf(OnFirePassiveSkillCondition()))
        },
    ...
    REDSTONE(
        ...
        listOf {
            LuckPassiveSkillEffect(0.5).on(listOf(IndoorPassiveSkillCondition()))
            AttackDamagePassiveSkillEffect(1.0).on(listOf(IndoorPassiveSkillCondition()))
            MaxHealthPassiveSkillEffect(2.0).on(listOf(IndoorPassiveSkillCondition()))
        },
    ...
    LAPIS_LAZULI(
        ...
        listOf {
            LuckPassiveSkillEffect(0.5).on(listOf())
            LuckPassiveSkillEffect(1.5).on(listOf(OverworldPassiveSkillCondition()))
        },
    ...
    GLOWSTONE(
        ...
        listOf {
            ...
            AttackDamagePassiveSkillEffect(1.5).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)))
        },
    ...
    OBSIDIAN(
        ...
        listOf {
            ...
            StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 1).on(listOf(MinimumManaPassiveSkillCondition(9.0)))
        },
    ...
    FISH(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.NIGHT_VISION, 0, additionalSeconds = 10).on(listOf(UnderwaterPassiveSkillCondition()))
    ...
    SPONGE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(UnderwaterPassiveSkillCondition()))
    ...
    PLAYER(
        ...
        listOf {
            ExperiencePassiveSkillEffect(0.05).on(listOf(MaximumLevelPassiveSkillCondition(29)))
        },
    ...
    WARDEN(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 1).on(listOf(MaximumLightLevelPassiveSkillCondition(0)))
            AttackDamagePassiveSkillEffect(2.0).on(listOf(MaximumLightLevelPassiveSkillCondition(0)))
        },
    ...
    ZOMBIE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(MaximumFoodLevelPassiveSkillCondition(6)))
            AttackDamagePassiveSkillEffect(1.0).on(listOf(ShadePassiveSkillCondition()))
        },
    ...
    WITHER(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 1).on(listOf(MaximumFoodLevelPassiveSkillCondition(6)))
            StatusEffectPassiveSkillEffect(StatusEffects.JUMP_BOOST, 1).on(listOf(MaximumFoodLevelPassiveSkillCondition(6)))
            StatusEffectPassiveSkillEffect(StatusEffects.HASTE, 0).on(listOf(MaximumFoodLevelPassiveSkillCondition(6)))
        },
    ...
    BLAZE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(OnFirePassiveSkillCondition()))
            CombustionPassiveSkillEffect().on(listOf(StatusEffectPassiveSkillCondition(StatusEffects.FIRE_RESISTANCE)))
        },
    ...
    WHEAT(
        ...
        listOf {
            RegenerationPassiveSkillEffect(0.1).on(listOf(MinimumFoodLevelPassiveSkillCondition(12)))
    ...
    POISONOUS_POTATO(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(1.0).on(listOf(MinimumFoodLevelPassiveSkillCondition(12)))
    ...
    WOOD(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.WOOD)))
            StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 0).on(listOf(ToolMaterialPassiveSkillCondition(ToolMaterialCard.WOOD)))
    ...
    SPRUCE(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(1.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FOREST)))
            AttackDamagePassiveSkillEffect(1.0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.TAIGA)))
        },
    ...
    HOE(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.HASTE, 0).on(listOf(HasHoePassiveSkillCondition()))
            LuckPassiveSkillEffect(3.0).on(listOf(HasHoePassiveSkillCondition()))
        },
    ...
    CRAFTING_TABLE(
        ...
        listOf {
            LuckPassiveSkillEffect(2.0).on(listOf(IndoorPassiveSkillCondition()))
        },
    ...
    ANVIL(
        ...
        listOf {
            AttackDamagePassiveSkillEffect(2.0).on(listOf(IndoorPassiveSkillCondition()))
        },
    ...
    HOPPER(
        ...
        listOf {
            CollectionPassiveSkillEffect(1.5).on(listOf(IndoorPassiveSkillCondition()))
        },
    ...
    BEACON(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 0).on(listOf(OutdoorPassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.HASTE, 0).on(listOf(OutdoorPassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 0).on(listOf(OutdoorPassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.JUMP_BOOST, 1).on(listOf(OutdoorPassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 0).on(listOf(OutdoorPassiveSkillCondition()))
            StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 0).on(listOf(OutdoorPassiveSkillCondition()))
        },
    ...
    GLASS(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.INVISIBILITY, 0).on(listOf(MaximumHealthPassiveSkillCondition(1)))
            StatusEffectPassiveSkillEffect(StatusEffects.INVISIBILITY, 0).on(listOf(MinimumManaPassiveSkillCondition(11.0)))
            StatusEffectPassiveSkillEffect(StatusEffects.GLOWING, 0).on(listOf(MaximumHealthPassiveSkillCondition(1)))
            StatusEffectPassiveSkillEffect(StatusEffects.GLOWING, 0).on(listOf(MinimumManaPassiveSkillCondition(11.0)))
        },
    ...
    PRISMARINE(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 1).on(listOf(UnderwaterPassiveSkillCondition()))
        },
    ...
    PLAINS(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.PLAINS)))
    ...
    OCEAN(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.OCEAN)))
    ...
    TAIGA(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.TAIGA)))
    ...
    MOUNTAIN(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.JUMP_BOOST, 0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MOUNTAIN)))
    ...
    FOREST(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FOREST)))
    ...
    AVALON(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 1).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)))
            StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 1).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FLORAL)))
            StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 1).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)))
            StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 1).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FLORAL)))
        },
    ...
    VOID(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.SLOW_FALLING, 0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)))
            StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 0).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)))
            StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 2).on(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)))
        },
    ...
    NIGHT(
        ...
        listOf {
            StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 0).on(listOf(NightPassiveSkillCondition()))
        },
        FairyRecipes().overworld(),
    ),
    TIME(
