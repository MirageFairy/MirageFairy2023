...
enum class FairyCard(
    ...
    AIR(
        ...
        listOf(PassiveSkillProvider(listOf(OverworldPassiveSkillCondition(), AirPassiveSkillCondition()), MovementSpeedPassiveSkillEffect(0.30 * 1.0))),
        RecipeContainer().always().block { Blocks.AIR },
    ),
    LIGHT(
        "light", 3, "Lightia", "光精リグチャ", 0xFFFFD8, 0xFFFFD8, 0xFFFFC5, 0xFFFF00,
        listOf(PassiveSkillProvider(listOf(MinimumLightLevelPassiveSkillCondition(12)), MovementSpeedPassiveSkillEffect(0.30 * 1.0))),
        RecipeContainer().always(),
    ),
    FIRE(
        "fire", 2, "Firia", "火精フィーリャ", 0xFF6C01, 0xF9DFA4, 0xFF7324, 0xFF4000,
        listOf(PassiveSkillProvider(listOf(OnFirePassiveSkillCondition()), AttackDamagePassiveSkillEffect(4.0 * 1.0))),
    ...
    WATER(
        ...
        listOf(PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition()), MaxHealthPassiveSkillEffect(12.0 * 1.0))),
    ...
    LAVA(
        ...
        listOf(
            PassiveSkillProvider(listOf(OnFirePassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
    ...
    RAIN(
        ...
        listOf(PassiveSkillProvider(listOf(InRainPassiveSkillCondition()), AttackDamagePassiveSkillEffect(4.0 * 1.0))),
        RecipeContainer().overworld(),
    ),
    DIRT(
        "dirt", 1, "Dirtia", "土精ディルチャ", 0xB87440, 0xB9855C, 0x593D29, 0x914A18,
        listOf(PassiveSkillProvider(listOf(OverworldPassiveSkillCondition()), MaxHealthPassiveSkillEffect(10.0 * 1.0))),
    ...
    MYCELIUM(
        ...
        listOf(
            PassiveSkillProvider(listOf(), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM)), MaxHealthPassiveSkillEffect(12.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MUSHROOM), FairyLevelPassiveSkillCondition(10.0)), StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 0)),
        ),
    ...
    SCULK(
        ...
        listOf(
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(0)), MaxHealthPassiveSkillEffect(8.0 * 1.0)),
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(0)), AttackDamagePassiveSkillEffect(3.0 * 1.0)),
        ),
    ...
    STONE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.STONE)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            ...
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.STONE), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 1)),
        ),
    ...
    DRIPSTONE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.5 * 1.0)),
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), MaxHealthPassiveSkillEffect(6.0 * 1.0)),
        ),
    ...
    REINFORCED_DEEPSLATE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), MaxHealthPassiveSkillEffect(10.0 * 1.0)),
        ),
    ...
    ANCIENT_DEBRIS(
        ...
        listOf(
            PassiveSkillProvider(listOf(), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), MaxHealthPassiveSkillEffect(2.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), LuckPassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    PURPUR(
        ...
        listOf(
            PassiveSkillProvider(listOf(), CollectionPassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_THE_END)), MaxHealthPassiveSkillEffect(4.0 * 1.0)),
        ),
    ...
    COPPER(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.2 * 1.0)),
            PassiveSkillProvider(listOf(ThunderingPassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.5 * 1.0)),
        ),
    ...
    IRON(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.IRON)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            ...
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.IRON), FairyLevelPassiveSkillCondition(8.0)), StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 1)),
        ),
    ...
    GOLD(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.8 * 1.0)),
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.GOLD)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            ...
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.GOLD), FairyLevelPassiveSkillCondition(10.0)), StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 1)),
        ),
    ...
    NETHERITE(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.NETHERITE)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            ...
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.NETHERITE), FairyLevelPassiveSkillCondition(12.0)), StatusEffectPassiveSkillEffect(StatusEffects.HASTE, 1)),
        ),
    ...
    MIRANAGITE(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5 * 1.0)),
            // TODO 妖精のレア度上昇
        ),
    ...
    AMETHYST(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(7)), AttackDamagePassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(7)), LuckPassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    EMERALD(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(InVillagePassiveSkillCondition()), LuckPassiveSkillEffect(1.5 * 1.0)),
        ),
    ...
    DIAMOND(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.DIAMOND)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            ...
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.DIAMOND), FairyLevelPassiveSkillCondition(12.0)), StatusEffectPassiveSkillEffect(StatusEffects.HASTE, 1)),
        ),
    ...
    ADAMANTITE(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    COAL(
        ...
        listOf(
            PassiveSkillProvider(listOf(), MaxHealthPassiveSkillEffect(4.0 * 1.0)),
            PassiveSkillProvider(listOf(OnFirePassiveSkillCondition()), LuckPassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    REDSTONE(
        ...
        listOf(
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), LuckPassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), MaxHealthPassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    LAPIS_LAZULI(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(0.5 * 1.0)),
            PassiveSkillProvider(listOf(OverworldPassiveSkillCondition()), LuckPassiveSkillEffect(1.5 * 1.0)),
        ),
    ...
    GLOWSTONE(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.IN_NETHER)), AttackDamagePassiveSkillEffect(1.5 * 1.0)),
        ),
    ...
    OBSIDIAN(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(FairyLevelPassiveSkillCondition(9.0)), StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 1)),
        ),
    ...
    FISH(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition(), FairyLevelPassiveSkillCondition(10.0)), StatusEffectPassiveSkillEffect(StatusEffects.WATER_BREATHING, 0)),
        ),
    ...
    SPONGE(
        ...
        listOf(
            PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            PassiveSkillProvider(listOf(UnderwaterPassiveSkillCondition(), FairyLevelPassiveSkillCondition(10.0)), StatusEffectPassiveSkillEffect(StatusEffects.REGENERATION, 0)),
        ),
    ...
    PLAYER(
        ...
        listOf(PassiveSkillProvider(listOf(MaximumLevelPassiveSkillCondition(29)), ExperiencePassiveSkillEffect(0.1 * 1.0))),
    ...
    ENDERMAN(
        ...
        listOf(PassiveSkillProvider(listOf(), CollectionPassiveSkillEffect(1.0 * 1.0))),
    ...
    WARDEN(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(MaximumLightLevelPassiveSkillCondition(0)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    ZOMBIE(
        ...
        listOf(
            PassiveSkillProvider(listOf(MaximumFoodLevelPassiveSkillCondition(6)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            PassiveSkillProvider(listOf(ShadePassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
        ),
    ...
    SKELETON_HORSE(
        ...
        listOf(
            PassiveSkillProvider(listOf(MaximumFoodLevelPassiveSkillCondition(6)), MovementSpeedPassiveSkillEffect(0.30 * 1.0)),
            PassiveSkillProvider(listOf(InRainPassiveSkillCondition()), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
        ),
    ...
    WHEAT(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1 * 1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BREAD }), RegenerationPassiveSkillEffect(0.3 * 1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BREAD }), AttackDamagePassiveSkillEffect(0.5 * 1.0)),
        ),
    ...
    POTATO(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1 * 1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BAKED_POTATO }), RegenerationPassiveSkillEffect(0.2 * 1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BAKED_POTATO }), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
        ),
    ...
    POISONOUS_POTATO(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.POISONOUS_POTATO }), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    BEETROOT(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1 * 1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.BEETROOT }), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
        ),
    ...
    MELON(
        ...
        listOf(
            PassiveSkillProvider(listOf(MinimumFoodLevelPassiveSkillCondition(12)), RegenerationPassiveSkillEffect(0.1 * 1.0)),
            PassiveSkillProvider(listOf(FoodPassiveSkillCondition { Items.MELON_SLICE }), RegenerationPassiveSkillEffect(0.4 * 1.0)),
        ),
    ...
    WOOD(
        ...
        listOf(
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.WOOD)), AttackDamagePassiveSkillEffect(2.0 * 1.0)),
            ...
            PassiveSkillProvider(listOf(ToolMaterialPassiveSkillCondition(ToolMaterials.WOOD), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 1)),
        ),
    ...
    SPRUCE(
        ...
        listOf(
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FOREST)), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.TAIGA)), AttackDamagePassiveSkillEffect(1.0 * 1.0)),
        ),
    ...
    HOE(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(HasHoePassiveSkillCondition()), LuckPassiveSkillEffect(3.0 * 1.0)),
        ),
    ...
    CRAFTING_TABLE(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), LuckPassiveSkillEffect(2.0 * 1.0))),
    ...
    ANVIL(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), AttackDamagePassiveSkillEffect(2.0 * 1.0))),
    ...
    ENCHANTING_TABLE(
        ...
        listOf(
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition(), MaximumLevelPassiveSkillCondition(19)), ExperiencePassiveSkillEffect(0.04 * 1.0)),
            PassiveSkillProvider(listOf(IndoorPassiveSkillCondition(), MaximumLevelPassiveSkillCondition(29)), ExperiencePassiveSkillEffect(0.06 * 1.0)),
        ),
    ...
    HOPPER(
        ...
        listOf(PassiveSkillProvider(listOf(IndoorPassiveSkillCondition()), CollectionPassiveSkillEffect(1.5 * 1.0))),
    ...
    GLASS(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(FairyLevelPassiveSkillCondition(11.0)), StatusEffectPassiveSkillEffect(StatusEffects.INVISIBILITY, 0)),
            PassiveSkillProvider(listOf(MaximumHealthPassiveSkillCondition(1)), StatusEffectPassiveSkillEffect(StatusEffects.GLOWING, 0)),
            PassiveSkillProvider(listOf(FairyLevelPassiveSkillCondition(11.0)), StatusEffectPassiveSkillEffect(StatusEffects.GLOWING, 0)),
        ),
    ...
    IRON_BARS(
        ...
        listOf(PassiveSkillProvider(listOf(), MaxHealthPassiveSkillEffect(5.0 * 1.0))),
    ...
    PLAINS(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.PLAINS), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.SPEED, 1)),
        ),
    ...
    OCEAN(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.OCEAN), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.LUCK, 1)),
        ),
    ...
    TAIGA(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.TAIGA), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 1)),
        ),
    ...
    MOUNTAIN(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.MOUNTAIN), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.JUMP_BOOST, 1)),
        ),
    ...
    FOREST(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.FOREST), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.RESISTANCE, 1)),
        ),
    ...
    DESERT(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.DESERT), SunshinePassiveSkillCondition(), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.FIRE_RESISTANCE, 0)),
            ...
            PassiveSkillProvider(listOf(BiomePassiveSkillCondition(ConventionalBiomeTags.DESERT), MoonlightPassiveSkillCondition(), FairyLevelPassiveSkillCondition(7.0)), StatusEffectPassiveSkillEffect(StatusEffects.STRENGTH, 1)),
        ),
    ...
    TIME(
        ...
        listOf(
            ...
            PassiveSkillProvider(listOf(), MovementSpeedPassiveSkillEffect(0.20 * 1.0)),
    ...
    DREAM(
        ...
        listOf(
            PassiveSkillProvider(listOf(), LuckPassiveSkillEffect(1.0 * 1.0)),
            PassiveSkillProvider(listOf(), RegenerationPassiveSkillEffect(0.1 * 1.0)),
...
private fun PassiveSkillProvider(conditions: List<PassiveSkillCondition>, effect: PassiveSkillEffect): PassiveSkill {
    return PassiveSkill(conditions, effect)
}
