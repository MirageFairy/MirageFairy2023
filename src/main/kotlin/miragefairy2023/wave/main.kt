...
fun main() {
    ...
    convert(File("""./src/main/resources/assets/miragefairy2023/sounds/magic_hit.8b.1000ms.8000a.scr.png"""))

    //File("""./src/main/resources/assets/miragefairy2023/sounds""").listFiles()?.forEach { inputFile ->
